...
import Accrordian from "../Components/Accrordian";
...
import { faqData } from "../utils/Constants.js";
...
const VisiterPage = () => {
  ...
  if(isAuth == null) return <LoaderScreen/>
  if(trendingMovies.length == 0) return <LoaderScreen/>

  return (
    <div className="min-h-screen max-w-screen flex flex-col bg-black text-white overflow-hidden ">
      <div className='page-1  relative overflow-hidden h-screen md:h-[82vh] lg:h-screen w-full bg-[linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url("/assets/background.jpg")] flex items-center justify-center flex-col'>
        <div className="header absolute top-0 w-full h-16 md:h-20 flex items-center px-4 sm:px-0 justify-between sm:justify-around bg-gradient-to-b from-black md:pt-2">
          <div className="left h-3/4 sm:h-full">
            <img className="h-full" src={Netflix_Logo} alt="" />
          </div>
          <div
            onClick={() => navigate("/login")}
            className="right h-1/2 bg-red-600 hover:bg-red-700 ease duration-75 rounded-md flex items justify-center cursor-pointer"
          >
            <button className="font-[my-font-bd] px-5 cursor-pointer text-sm lg:text-base">Sign Up</button>
          </div>
        </div>
        <div className="page1-content  w-[85vw] md:w-[45rem] lg:w-[50rem] flex flex-col items-center gap-6 -mt-28">
          <h1 className="text-3xl sm:text-5xl md:text-5xl lg:text-7xl text-center font-[my-font-bd]">
            Unlimited movies, TV shows and more
          </h1>
          <p className="text-md font-[my-font-md] text-center">
          ...
          <div className="flex w-full flex-col items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row h-30 sm:h-14 gap-4 w-full justify-center items-center">
              <div className="form-group h-1/2 sm:h-full sm:w-6/12 w-full ">
              ...
              <button  onClick={() => navigate(`/login?email=${visitorEmailRef.current.value}`)} className="md:w-3/12  h-1/2 sm:h-full text-md md:text-xl px-3 py-1 flex items-center justify-center font-[my-font-md] gap-1 bg-red-600 hover:bg-red-700 ease duration-75 cursor-pointer rounded-lg ">
      ...
      <div className="absolute  h-screen md:h-[82vh] lg:h-screen w-full  bg-gradient-to-t from-black/100 via-black/1 to-transparent pointer-events-none" />
      <div className="page-2 py-10  max-w-screen flex flex-col gap-20  md:px-20 2xl:px-80 mt-10">
        <div className="w-full text-white">
          <div className="flex flex-col gap-3 md:gap-6 h-55 sm:h-65 lg:h-70 xl:h-70 2xl:h-90 w-full">
            <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-[my-font-bd] px-5 md:px-15">
              Top Picks
            </h2>
            <div className="card-container w-full flex-1 min-h-0 px-5 lg:px-15 relative overflow-hidden">
              <Swiper
              ...
              >
                {trendingMovies.map((movie, index) => (
                  <SwiperSlide
                    key={movie.movieId}
                    className="swiper-slide h-full aspect-[12/16]"
                  >
                    <div
                      onMouseEnter={() => handleHover(movie.movieId)}
                      onMouseLeave={removeHover}
                      className="item aspect-[12/16] h-full rounded-xl relative cursor-pointer"
                    >
                      ...
                      <div
                        className={`w-full h-full  absolute bg-gradient-to-t from-black to-transparent ease duration-150 rounded-xl flex flex-col justify-end top-0 md:top-${hover === movie.movieId ? "0" : "full"}`}
                      >
                       <p className="text-center text-xs  sm:text-sm xl:text-base text-red-500 font-[my-font-Bd]">Sign in <br /><span className="text-center font-[my-font-Rg] text-white">To Watch</span></p>
                      </div>
                    </div>
                  </SwiperSlide>
                ))}
      ...
      <div className="page-3 max-w-screen px-5 md:px-20 2xl:px-80 flex flex-col gap-4 items-center mt-10">
        ...
        <div className="w-full lg:w-3/4 mt-10 flex flex-col gap-5">
          ...
          <div className="gap-4 w-full md:h-14 flex flex-col sm:flex-row ">
            ...
            <button  onClick={() => navigate(`/login?email=${visitorEmailRef2.current.value}`)} className="w-3/6 md:2/6 h-full text-md md:text-lg px-3 py-4 flex items-center justify-center font-[my-font-md] gap-1 bg-red-600 hover:bg-red-700 ease duration-75 cursor-pointer rounded-lg ">
              Get Started <ChevronRight />
            </button>
          </div>
        </div>
      ...
      <div className="footer  h-auto pt-20 pb-26 lg:pb-40  max-w-screen px-5 md:px-20 2xl:px-80 flex flex-col gap-9 text-[#ffffffc3] text-sm">
        <h4 className="text-md">
          Questions? Call
          <span className="underline cursor-pointer">  000-800-919-1743</span>
        </h4>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 underline gap-3 cursor-pointer">
          <p>FAQ</p>
          <p>Help Centre</p>
          <p>Account</p>
          <p>Media Centre</p>
